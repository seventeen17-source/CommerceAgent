...
| `source_tier` | 是 | A 企业官方完整 JD；B 企业官方招聘/团队页；C 高校就业中心或权威渠道完整转载且可追溯企业；D 聚合/搜索摘要，仅发现线索 |
...
- 核心技能统计优先使用 A；C 仅在 JD 完整且可追溯企业时可纳入核心样本。
- B 若没有完整 JD，只能证明招聘方向，不进入详细职责/硬性要求的核心统计。
- D 仅用于发现线索，不进入核心分母，也不能独立支持能力结论。
