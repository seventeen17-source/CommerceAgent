...
function buildLiveSteps(completed: CompletedLiveSteps, failedStep: LiveStepId | null): FlowStep[] {
  ...
  return [
    ...
    },
    {
      ...
      work: 'T025 通过 Vite dev proxy 直连 Java :8080；Java 从认证 principal、订单、物流和规则表计算权威 EligibilityDecision，reasonCode 只作为描述性上下文，不能扩大金额或授权。',
      ...
      note: '这是 T025 的真实 Java API 页面验收，不经过 Agent Tool；真正 Agent → Tool → CommerceClient → Java 的链路在 T029/T030/T032 接入。',
    },
    {
      id: 'create-run',
      live: 'create-run',
