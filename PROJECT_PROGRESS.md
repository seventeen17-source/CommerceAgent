...
- **当前 Tasks**：T011（实现完成，待本地 `mvnw verify` 验收）
- **已完成**：
...
- **当前优先任务**：验收 T011 — 本地 JWT 认证和 role-aware principal（`foundation/jwt-security`）
...
| 2 | Foundation | T008–T018 | AgentRun / Auth / DB boundary / Trace 基础能力可用 | 👉 Current（T008–T010 ✅，当前 T011） |
...
4. 🟨 T011：JWT / role-aware principal（代码已提交，待本地 verify 后勾选 tasks.md）
